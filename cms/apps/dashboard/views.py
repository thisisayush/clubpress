...
from apps.core.utils import getOptions, setOption, getOption
...
def IndexView(request):
    if has_role(request.user, Admin):
        ...
        return render(request, "dashboard/index-subscriber.html")
    else:
...
def TestView(request):
    ...
    return HttpResponse(send_mail("Test Mail", ["thisisayushaa@gmail.com"], "Test Mail Success!"))
